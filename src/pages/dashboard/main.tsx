...
const formatListDate = (value?: string) => value ? new Intl.DateTimeFormat('pt-BR', { day: '2-digit', month: 'short', year: 'numeric' }).formatToParts(new Date(value)).filter(part => ['day', 'month', 'year'].includes(part.type)).map(part => part.value).join(' ') : '—';
